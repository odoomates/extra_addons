odoo.define('web_flectra.sidemenu', function (require) {
"use strict";
...
odoo.define('web_flectra.sidemenu.AppsMenu', function(require) {
    "use strict";
...
odoo.define('web_flectra.sidemenu.webclient', function(require) {
    "use strict";
